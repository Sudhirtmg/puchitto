...
class Package(models.Model):
    ...
    old_price = models.DecimalField(max_digits=99999999999999, decimal_places=2, default="2.99,verbose_name='金額'")
...
class Book(models.Model):
    ...
    date = models.DateTimeField(auto_now_add=True, null=True, blank=True,verbose_name='予約の日付')
